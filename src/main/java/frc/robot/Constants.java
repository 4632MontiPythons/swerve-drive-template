...
public final class Constants {
    ...
    public static final class Drive {
        ...
        public static final double odometryXYStdDevs = 0.05;
        public static final double odometryThetaStdDev = 0.02;
    }
    ...
    public static final class Vision {
        ...
        //We'll really only see single tags when in the neutral zone, and we don't use pose estimation there, and the information we gleaned will be slightly messed up after going over the bump anyways

        public static final double maxYawRate_DegPerSec = 500; //ignore visual measurements when yaw rate is greater than this value
        public static final double maxTagDistance_Meters = 4.0; //ignore visual measurements when distance to tag is greater than this value.
        public static final double minStdDev_Meters = 0.01; //std dev for xy vision measurement can never be smaller than this value
        public static final double stdDevPerMeter = 0.025; //Std dev increase per meter; farther from tag means less accurate measurement
    }
