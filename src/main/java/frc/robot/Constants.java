...
public final class Constants {
    ...
    public static final class Vision {
        public static final int minTags = 2; //*Should always be at least 1*, decide between 1 and 2. This year I think 2 is better because the tags usually comes in pairs of two, so it is ok to ignore singular tags
    ...
    public static final class OI {
        public static final double deadbandProportion = 0.10; //percentage of max speed/rotational rate. e.g. 10% deadband should be 0.10
    }
